...
/**-------------------- Google Maps Settings --------------------**/
    ...
    var GoogleMaps = {
        init: function() {
            ...
            $mapColors = new Array('#c6c1bc', '#ffffff', '#3f3a35');

            var styles = [{"featureType": "landscape", "stylers": [{ "color": $mapColors[0] }]}, {"featureType": "road.highway", "stylers": [{ "color": $mapColors[1]}]}, {"stylers": [{ "saturation": -100 }, { "hue": $mapColors[2] }]}];
